    ...
    return (
        <section className='w-full bg-[#0C0C0C] py-28'>
            <div className='max-w-7xl mx-auto lg:px-10'>
                ...
                {/* Leadership start */}
                <p className='text-center text-4xl font-bold pb-6'>Leadership</p>
                <div className='flex flex-wrap justify-center gap-3 lg:gap-5'>
                    {data.results.map((item: any, key: any) => (
                        <div key={key} className='bg-slate-900 rounded-md w-48'>
                            ...
                            <p className='text-center'>{item.location.country}</p>
                        </div>
                    ))}
                </div>
                {/* Leadership end */}
                ...
                {/* Creative start */}
                <p className='text-center text-4xl font-bold pt-20 pb-6'>Creative</p>
                <div className='flex flex-wrap justify-center gap-3 lg:gap-5'>
                    {data.results.map((item: any, key: any) => (
                        <div key={key} className='bg-slate-900 rounded-md w-48'>
                            <Image src={item.picture.large} alt='person' width={150} height={150} className='mx-auto p-2' />
                ...
                {/* Development start */}
                <p className='text-center text-4xl font-bold pt-20 pb-6'>Development</p>
                <div className='flex flex-wrap justify-center gap-3 lg:gap-5'>
                    {data.results.map((item: any, key: any) => (
                        <div key={key} className='bg-slate-900 rounded-md w-48'>
                            <Image src={item.picture.large} alt='person' width={150} height={150} className='mx-auto p-2' />
