...
function Management() {
    return (
        <section className='w-full pt-24 md:pt-28 bg-gray-900 lg:bg-[#0C0C0C]'>
            ...
            <div className='max-w-6xl flex mx-auto flex-col items-center justify-center'>
                ...
                <h1 className='text-4xl text-center text-white font-bold w-[320px] mb-10 md:text-5xl md:w-[700px] '>Doing business responsibly and sustainably</h1>
                <p className='text-center text-gray-200 text-sm md:text-base w-[320px] md:w-[530px] mb-24'>As a responsible company, we operate sustainably, to high Environmental, Social and Governance (ESG) standards. We continue to embed sustainability ever deeper in the way we do business – in our own operations and beyond, together with our partners.</p>
            </div>
        </section>
    )
}
