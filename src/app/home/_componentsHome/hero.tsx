...
function Hero() {
    return (
        <section className='w-full  mx-auto pt-24 bg-[#0C0C0C] '>
            <div className='mx-auto max-w-7xl pt-16 relative'>
                ...
                <div className='flex flex-wrap items-center justify-center lg:px-32 lg:justify-between'>
                    <div className='w-[300px] md:w-[320px] z-20'>
                        <Image
                            src={logo}
                            width={500}
                            alt='ai robot'
                    ...
                    <div className='bg-gray-900 w-screen lg:w-[320px] lg:bg-transparent lg:justify-normal flex justify-center py-16 '>
                        <div className='lg:bg-transparent w-[300px] border-4 p-7  lg:p-10  lg:h-64'>
