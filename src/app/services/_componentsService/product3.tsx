...
import handrobot1 from '@/app/services/_assetsService/handrobot1.jpg'
import handrobot2 from '@/app/services/_assetsService/handrobot2.jpg'
import handrobot3 from '@/app/services/_assetsService/handrobot3.jpg'
import handrobot4 from '@/app/services/_assetsService/handrobot4.jpg'
import handrobot5 from '@/app/services/_assetsService/handrobot5.jpg'
import handrobot6 from '@/app/services/_assetsService/handrobot6.jpg'
import Image from 'next/image'

function Product3() {
  return (
    <section id='produk3' className='bg-stone-950 w-full py-20'>
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-wrap lg:items-center'>
          ...
          <div className='mx-auto pb-[28px]'>
            <Image src={handrobot1} alt='hand robot 1' width={900} className='object-cover object-bottom w-[300px] lg:w-[350px] h-[470px] rounded-2xl hover:scale-105 transition-all duration-500' />
          </div>
        </div>
        ...
        <div className='flex flex-wrap justify-center items-center lg:justify-around pb-16 lg:px-16'>
          <div className='flex flex-wrap pb-10 '>
            <div className='flex flex-col text-white px-8 lg:pr-12 border-r-2'>
              ...
              <p className='text-3xl font-semibold py-1 lg:py-3 lg:text-4xl'>8h</p>
            ...
            <div className='flex flex-col text-white px-8 lg:pr-12 border-r-2'>
              ...
              <p className='text-3xl font-semibold  lg:text-4xl lg:py-3 py-1'>30m</p>
            ...
            <div className='flex flex-col text-white px-8'>
              ...
              <p className='text-lg lg:text-xl'>Advanced sensory</p>
            </div>
          </div>
          ...
          <div className='flex gap-6 pb-10 lg:py-0  '>
            <div className='relative hover:scale-105 transition-all duration-500'>
              ...
              <p className='text-white  border backdrop-blur-lg py-1 px-2 rounded-md absolute bottom-3 left-3 font-semibold'>All View</p>
            </div>
            <div className='relative hover:scale-105 transition-all duration-500'>
              ...
              <p className='text-white border backdrop-blur-lg py-1 px-2 rounded-md absolute top-3 right-3 font-semibold'>Hand View</p>
            </div>
          </div>
        </div>
        {/* Kualitas robot end */}
