            ...
            <div className='max-w-7xl mx-auto'>
                <div className='flex flex-wrap lg:items-center'>
                    ...
                    <div className='mx-auto pb-[28px]'>
                        <Image src={car3} alt='hand robot 1' width={900} className='object-cover object-bottom w-[300px] lg:w-[350px] h-[470px] rounded-2xl hover:scale-105 transition-all duration-500' />
                    </div>
                </div>
                ...
                <div className='flex flex-wrap justify-center items-center lg:justify-around pb-16 lg:px-16'>
                    ...
                    <div className='flex gap-6 pb-10 lg:py-0  '>
                        <div className='relative hover:scale-105 transition-all duration-500'>
                            ...
                            <p className='text-white  border backdrop-blur-lg py-1 px-2 rounded-md absolute bottom-3 left-3 font-semibold'>Back View</p>
                        </div>
                        <div className='relative hover:scale-105 transition-all duration-500'>
                            ...
                            <p className='text-white border backdrop-blur-lg py-1 px-2 rounded-md absolute top-3 right-3 font-semibold'>Top View</p>
                        </div>
                    </div>
                </div>
                {/* Kualitas robot end */}
