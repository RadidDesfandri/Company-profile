    ...
    return (
        <section className='w-full py-20 bg-stone-950'>
            <div className='max-w-7xl mx-auto flex flex-col'>
                ...
                <div className='flex flex-wrap justify-center mx-auto gap-3 lg:gap-5 pb-20'>
                    <div className=' w-[200px] h-[250px] lg:w-[360px] lg:h-[250px] lg:p-8 flex flex-col justify-center bg-slate-700 bg-opacity-25 p-2  rounded-lg text-white'>
                    ...
                    <div className=' w-[200px] h-[250px] lg:w-[360px] lg:h-[250px] lg:p-8 flex flex-col justify-center bg-slate-700 bg-opacity-25 p-2 rounded-lg text-white'>
                        ...
                        <p className='text-xl font-semibold'>for MedTech patent filings
                            with European Patent Office in 2023</p>
                    </div>
                    <div className=' w-[200px] h-[250px] lg:w-[360px] lg:h-[250px] lg:p-8 flex flex-col justify-center bg-slate-700 bg-opacity-25 p-2 rounded-lg text-white'>
                        <h1 className='text-3xl pb-2 font-bold'>Clarivate Top
                            100 Global Innovator  </h1>
                        <p className='text-xl font-semibold'>11th year in a row</p>
                    </div>
                </div>
